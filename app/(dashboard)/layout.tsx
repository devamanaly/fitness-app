...
import { SideBarNavigation } from '@/components/Dashboard/sidebar/SidebarData'
  ...
  notifications: [
    {
      ...
      message: 'Your workout starts in 30 minutes',
      time: '5 min ago',
    },
    {
      id: 2,
      title: 'Streak milestone',
      message: 'You reached a 15-day streak!',
      time: '2 hours ago',
    },
    {
      id: 3,
      title: 'AI Coach tip',
      message: 'Try increasing your water intake today',
      time: '5 hours ago',
    },
  ],
}
          ...
          >
            <div className="relative">
              <button
                ...
                className={`flex items-center space-x-3 w-full px-4 py-3 rounded-xl hover:bg-white/[0.04] transition-all ${
                  sidebarCollapsed
              ...
              {userMenuOpen && (
                <>
                  ...
                  <div
                    className={`absolute bottom-full left-0 right-0 mb-2 bg-[#1a1a1c] border border-white/10 rounded-xl shadow-2xl overflow-hidden z-50 ${
                      sidebarCollapsed
                        ? 'lg:left-1/2 lg:-translate-x-1/2 lg:w-48'
                        : ''
                    }`}
                  >
                    <Link
        ...
        <header className="sticky top-0 z-30 bg-[#0a0a0b]/80 backdrop-blur-lg border-b border-white/[0.06]">
          <div className="flex items-center justify-between px-4 sm:px-6 py-3 sm:py-4">
            ...
            <div className="flex items-center space-x-2 sm:space-x-3">
                    ...
                    <div className="absolute right-0 mt-2 w-72 sm:w-80 bg-[#1a1a1c] border border-white/10 rounded-xl shadow-2xl overflow-hidden z-50">
                      ...
                      <div className="max-h-96 overflow-y-auto">
                        {mockUser.notifications.map((notif) => (
                          <div
                            key={notif.id}
                            className="p-4 hover:bg-white/5 border-b border-white/5"
                          >
              ...
              <button
                className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-br from-gray-700 to-gray-900 rounded-full border border-white/10 hover:border-white/20 transition-all flex items-center justify-center"
